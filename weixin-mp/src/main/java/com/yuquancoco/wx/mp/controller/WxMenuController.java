...
//        menu.getButtons().add(button2);
        ...
        button31.setName("管网地址");
        button31.setUrl("http://www.yuquancoco.cn");
        ...
        if (servletRequestAttributes != null) {
            ...
            String url = this.wxService.switchoverTo(appid).getOAuth2Service().buildAuthorizationUrl(
                String.format("%s://%s/dinosaur-admin/wx/redirect/%s/greet", requestURL.getProtocol(), requestURL.getHost(), appid),
                WxConsts.OAuth2Scope.SNSAPI_USERINFO, null);
            log.info("getProtocol===【{}】", requestURL.getProtocol());
            log.info("requestURL.getHost()===【{}】", requestURL.getHost());
            log.info("微信授权跳转地址url【{}】", url);
            button34.setUrl(url);
        }
