...
import com.yuquancoco.common.utils.ip.AddressUtils;
...
public class WeChatTokenService {
    ...
    public WeChatLoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            ...
            // 解析对应的权限以及用户信息
            String uuid = (String) claims.get(Constants.WECHAT_LOGIN_TOKEN_KEY);
            String userKey = getTokenKey(uuid);
            return redisCache.<WeChatLoginUser>getCacheObject(userKey);
        }
        return null;
    }
     ...
     * @return 令牌
     */
    public String createToken(WeChatLoginUser loginUser) {
        String token = IdUtils.fastSimpleUUID();
        loginUser.setToken(token);
        setUserAgent(loginUser);
        refreshToken(loginUser);
        Map<String, Object> claims = new HashMap<>();
        claims.put(Constants.WECHAT_LOGIN_TOKEN_KEY, token);
     ...
     * @return 令牌
     */
    public void verifyToken(WeChatLoginUser loginUser)
    {
     ...
     * @param loginUser 登录信息
     */
    public void setUserAgent(WeChatLoginUser loginUser)
    {
    ...
    {
        return Constants.WECHAT_LOGIN_TOKEN_KEY + uuid;
    }
}
